    ...
    _computeBarycentricValues: {
        value: function (x, y) {
            if (this._width && this._height) {
                return [
                    1 - (y / this._height),
                    (x * Math.sin(Math.PI / 3) - (y - this._height) * Math.cos(Math.PI / 3)) / this._height,
                    ((this._width - x) * Math.sin(Math.PI / 3) - (y - this._height) * Math.cos(Math.PI / 3)) / this._height
                ];
            } else {
                return [1/3, 1/3, 1/3];
            }
        ...
        set: function (value) {
            ...
            if (value) {
                ...
                if (this._valuesInRange(barycentricValues)) {
                    ...
                    this.barycentricValues = this._computeBarycentricValues(
